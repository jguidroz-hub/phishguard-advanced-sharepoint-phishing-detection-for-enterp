  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">PhishGuard - Advanced SharePoint phishing detection for enterprise email security</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Detects sophisticated credential phishing attacks using compromised SharePoint links that bypass Mimecast and Defender, protecting enterprises from advanced social engineering.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust PhishGuard - Advanced SharePoint phishing detection for enterprise email security.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} PhishGuard - Advanced SharePoint phishing detection for enterprise email security. All rights reserved.</p>
