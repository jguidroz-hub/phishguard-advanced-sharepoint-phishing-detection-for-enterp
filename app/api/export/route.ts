  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="PhishGuard - Advanced SharePoint phishing detection for enterprise email security-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
