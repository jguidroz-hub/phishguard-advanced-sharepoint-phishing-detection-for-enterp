...
const FROM = process.env.EMAIL_FROM || 'PhishGuard - Advanced SharePoint phishing detection for enterprise email security <noreply@example.com>';
const APP_NAME = 'PhishGuard - Advanced SharePoint phishing detection for enterprise email security';
